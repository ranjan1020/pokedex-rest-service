...
public class ApiResourceList {
    ...
    private List<ApiResource> results = new ArrayList<ApiResource>();
    @JsonIgnore
    ...
    public String toString() {
        ...
        sb.append(ApiResourceList.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("count");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof ApiResourceList) == false) {
            return false;
        }
        ApiResourceList rhs = ((ApiResourceList) other);
